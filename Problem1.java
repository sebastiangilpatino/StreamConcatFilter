...
public class Problem1 {
	...
	public static List<String> elementsInJustOne(List<String> list1, List<String> list2) {
		...
		return Stream.concat(list1.stream(), list2.stream())
				.filter(e -> list1.contains(e) && !list2.contains(e) || list2.contains(e) && !list1.contains(e))
	...
	public static List<String> getAllFairfieldCustomers(List<Customer> list) {
		// implement
		return list.stream().filter(c -> c.getCity().equals("Fairfield")).map(c -> c.getName())
	...
	private static void testFirstMethod() {
		// List<String> list1 = Arrays.asList(new String[] { "friend", "tree", "bike",
		// "bat" });
		// List<String> list2 = Arrays.asList(new String[] { "tree", "strong", "bike",
		// "weak" });
		List<String> list1 = Arrays.asList(new String[] { "A", "B", "D" });
